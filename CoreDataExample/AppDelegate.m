...
- (NSURL*)storeURL
{
    ...
    return [documentsDirectory URLByAppendingPathComponent:@"CoreDataExample.sqlite"];
}

- (NSURL*)modelURL
{
    return [[NSBundle mainBundle] URLForResource:@"CoreDataExample" withExtension:@"momd"];
}
